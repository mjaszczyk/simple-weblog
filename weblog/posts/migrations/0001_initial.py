...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 13, 5, 48, 850894)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 1, 13, 5, 48, 850755)'}),
        ...
        'posts.post': {
            'Meta': {'ordering': "('-create_time',)", 'object_name': 'Post'},
